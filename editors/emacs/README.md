...
A major mode for [Spork](https://spork.sh/docs/packages/spork-lang/) with full nREPL integration. Provides a CIDER-like development experience for Spork, a Lisp dialect that compiles to Python.
