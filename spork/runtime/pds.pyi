...
class Cons(Generic[T]):
    ...
    def __reduce__(self) -> tuple[type, tuple[T, Cons[T] | None]]: ...
...
class Vector(Generic[T]):
    ...
    def __class_getitem__(cls, item: Any) -> Any: ...
    def __reduce__(self) -> tuple[type, tuple[T, ...]]: ...
    ...
    def sort(self, *, key: Any = None, reverse: bool = False) -> Vector[T]: ...
...
class SortedVector(Generic[T]):
    def __init__(
        self, iterable: Any = None, *, key: Any = None, reverse: bool = False
    ) -> None: ...
    def __iter__(self) -> Iterator[T]: ...
    def __len__(self) -> int: ...
    def __getitem__(self, index: int) -> T: ...
    ...
    def __contains__(self, item: object) -> bool: ...
    def __class_getitem__(cls, item: Any) -> Any: ...
    def __reduce__(self) -> tuple[Any, tuple[tuple[T, ...]]]: ...
    def __getnewargs_ex__(self) -> tuple[tuple[tuple[T, ...]], dict[str, Any]]: ...
    def nth(self, index: int, default: T = ...) -> T: ...
    def conj(self, val: T) -> SortedVector[T]: ...
    def disj(self, val: T) -> SortedVector[T]: ...
    def first(self) -> T | None: ...
    def last(self) -> T | None: ...
    def index_of(self, val: T) -> int: ...
    def rank(self, val: T) -> int: ...
    def transient(self) -> TransientSortedVector[T]: ...

class TransientSortedVector(Generic[T]):
    def __len__(self) -> int: ...
    def conj_mut(self, val: T) -> TransientSortedVector[T]: ...
    def disj_mut(self, val: T) -> TransientSortedVector[T]: ...
    def persistent(self) -> SortedVector[T]: ...
...
EMPTY_SET: Set[Any]
EMPTY_SORTED_VECTOR: SortedVector[Any]
...
def sorted_vec(
    iterable: Any = None, *, key: Any = None, reverse: bool = False
) -> SortedVector[Any]: ...
